//GitHub - @killerbean3 - LoremIpsum-Javascript
const text = [
...
//listening for submit of form
form.addEventListener("submit", function (e) {
  // A click on a form submit button – initiates its submission to the server.
  //we prevent by below
  e.preventDefault();
  //change to int as will be str by default
  const value = parseInt(amount.value);
  //random num gen
  const random = Math.floor(Math.random() * text.length);

  //if it has no value, smaller or equal to 0 and bigger than 9
